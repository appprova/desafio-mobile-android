...
public class PullBase implements Parcelable {
    ...
    public static final Creator<PullBase> CREATOR = new Creator<PullBase>() {
        @Override
        public PullBase createFromParcel(Parcel in) {
            return new PullBase(in);
        }

        @Override
        public PullBase[] newArray(int size) {
            return new PullBase[size];
        }
    };
